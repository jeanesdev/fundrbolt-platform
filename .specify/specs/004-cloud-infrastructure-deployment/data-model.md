...
**Custom Domain**:
- Production: `api.fundrbolt.app`
- Staging: `api-staging.fundrbolt.app`
...
**Custom Domain**:
- Production: `admin.fundrbolt.app`
- Staging: `admin-staging.fundrbolt.app`
...
- Domain: `fundrbolt.app` (production), `staging.fundrbolt.app` (staging)
- Sender addresses:
  - `noreply@fundrbolt.app` - Automated notifications
  - `support@fundrbolt.app` - Customer support (forwarded)
  - `billing@fundrbolt.app` - Payment notifications
...
- TXT: DMARC policy - `v=DMARC1; p=quarantine; rua=mailto:dmarc@fundrbolt.app`
...
| _dmarc | TXT | 3600 | `v=DMARC1; p=quarantine; rua=mailto:dmarc@fundrbolt.app` | DMARC policy |
