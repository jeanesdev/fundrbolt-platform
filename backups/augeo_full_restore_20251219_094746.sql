...
\restrict MpDITcy4TFX4jLJCcgNVZfp6dhsucCggxj4dBMFkp5ld0G03Z1Rfg3WdGkX1YVI
...
ALTER TABLE IF EXISTS ONLY public.user_consents DROP CONSTRAINT IF EXISTS user_consents_tos_document_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_consents DROP CONSTRAINT IF EXISTS user_consents_privacy_document_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sponsors DROP CONSTRAINT IF EXISTS sponsors_event_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sponsors DROP CONSTRAINT IF EXISTS sponsors_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.registration_guests DROP CONSTRAINT IF EXISTS registration_guests_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.registration_guests DROP CONSTRAINT IF EXISTS registration_guests_registration_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npos DROP CONSTRAINT IF EXISTS npos_created_by_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npo_members DROP CONSTRAINT IF EXISTS npo_members_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npo_members DROP CONSTRAINT IF EXISTS npo_members_npo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npo_members DROP CONSTRAINT IF EXISTS npo_members_invited_by_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npo_branding DROP CONSTRAINT IF EXISTS npo_branding_npo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npo_applications DROP CONSTRAINT IF EXISTS npo_applications_reviewed_by_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.npo_applications DROP CONSTRAINT IF EXISTS npo_applications_npo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.meal_selections DROP CONSTRAINT IF EXISTS meal_selections_registration_id_fkey;
ALTER TABLE IF EXISTS ONLY public.meal_selections DROP CONSTRAINT IF EXISTS meal_selections_guest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.meal_selections DROP CONSTRAINT IF EXISTS meal_selections_food_option_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invitations DROP CONSTRAINT IF EXISTS invitations_npo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invitations DROP CONSTRAINT IF EXISTS invitations_invited_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invitations DROP CONSTRAINT IF EXISTS invitations_invited_by_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.food_options DROP CONSTRAINT IF EXISTS food_options_event_id_fkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_npo_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.event_media DROP CONSTRAINT IF EXISTS event_media_uploaded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.event_media DROP CONSTRAINT IF EXISTS event_media_event_id_fkey;
ALTER TABLE IF EXISTS ONLY public.event_links DROP CONSTRAINT IF EXISTS event_links_event_id_fkey;
ALTER TABLE IF EXISTS ONLY public.event_links DROP CONSTRAINT IF EXISTS event_links_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.cookie_consents DROP CONSTRAINT IF EXISTS cookie_consents_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.consent_audit_logs DROP CONSTRAINT IF EXISTS consent_audit_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.auction_items DROP CONSTRAINT IF EXISTS auction_items_sponsor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.auction_items DROP CONSTRAINT IF EXISTS auction_items_event_id_fkey;
ALTER TABLE IF EXISTS ONLY public.auction_items DROP CONSTRAINT IF EXISTS auction_items_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.auction_item_media DROP CONSTRAINT IF EXISTS auction_item_media_auction_item_id_fkey;
DROP TRIGGER IF EXISTS trg_check_bidder_number_uniqueness ON public.registration_guests;
DROP TRIGGER IF EXISTS prevent_consent_audit_update ON public.consent_audit_logs;
DROP INDEX IF EXISTS public.ix_users_role_id;
DROP INDEX IF EXISTS public.ix_users_email;
DROP INDEX IF EXISTS public.ix_user_consents_user_id;
DROP INDEX IF EXISTS public.ix_user_consents_status;
DROP INDEX IF EXISTS public.ix_sessions_user_id;
DROP INDEX IF EXISTS public.ix_sessions_refresh_token_jti;
DROP INDEX IF EXISTS public.ix_sessions_created_at;
DROP INDEX IF EXISTS public.ix_roles_name;
DROP INDEX IF EXISTS public.ix_registration_guests_user_id;
DROP INDEX IF EXISTS public.ix_registration_guests_registration_id;
DROP INDEX IF EXISTS public.ix_registration_guests_email;
DROP INDEX IF EXISTS public.ix_npos_status;
DROP INDEX IF EXISTS public.ix_npos_name;
DROP INDEX IF EXISTS public.ix_npos_email;
DROP INDEX IF EXISTS public.ix_npos_created_by_user_id;
DROP INDEX IF EXISTS public.ix_npo_members_user_id;
DROP INDEX IF EXISTS public.ix_npo_members_status;
DROP INDEX IF EXISTS public.ix_npo_members_role;
DROP INDEX IF EXISTS public.ix_npo_members_npo_id;
DROP INDEX IF EXISTS public.ix_npo_branding_npo_id;
DROP INDEX IF EXISTS public.ix_npo_applications_submitted_at;
DROP INDEX IF EXISTS public.ix_npo_applications_status;
DROP INDEX IF EXISTS public.ix_npo_applications_npo_id;
DROP INDEX IF EXISTS public.ix_meal_selections_registration_id;
DROP INDEX IF EXISTS public.ix_meal_selections_guest_id;
DROP INDEX IF EXISTS public.ix_meal_selections_food_option_id;
DROP INDEX IF EXISTS public.ix_legal_documents_status;
DROP INDEX IF EXISTS public.ix_legal_documents_published_at;
DROP INDEX IF EXISTS public.ix_legal_documents_document_type;
DROP INDEX IF EXISTS public.ix_invitations_token_hash;
DROP INDEX IF EXISTS public.ix_invitations_status;
DROP INDEX IF EXISTS public.ix_invitations_npo_id;
DROP INDEX IF EXISTS public.ix_invitations_expires_at;
DROP INDEX IF EXISTS public.ix_invitations_email;
DROP INDEX IF EXISTS public.ix_food_options_event_id;
DROP INDEX IF EXISTS public.ix_events_status;
DROP INDEX IF EXISTS public.ix_events_slug;
DROP INDEX IF EXISTS public.ix_events_npo_id;
DROP INDEX IF EXISTS public.ix_events_event_datetime;
DROP INDEX IF EXISTS public.ix_event_registrations_user_id;
DROP INDEX IF EXISTS public.ix_event_registrations_status;
DROP INDEX IF EXISTS public.ix_event_registrations_event_id;
DROP INDEX IF EXISTS public.ix_event_media_event_id;
DROP INDEX IF EXISTS public.ix_event_links_event_id;
DROP INDEX IF EXISTS public.ix_cookie_consents_user_id;
DROP INDEX IF EXISTS public.ix_cookie_consents_session_id;
DROP INDEX IF EXISTS public.ix_consent_audit_logs_user_id;
DROP INDEX IF EXISTS public.ix_consent_audit_logs_created_at;
DROP INDEX IF EXISTS public.ix_consent_audit_logs_action;
...
DROP INDEX IF EXISTS public.idx_users_search_vector;
DROP INDEX IF EXISTS public.idx_user_event_status;
DROP INDEX IF EXISTS public.idx_sponsors_event_id;
DROP INDEX IF EXISTS public.idx_sponsors_display_order;
DROP INDEX IF EXISTS public.idx_sponsors_created_by;
DROP INDEX IF EXISTS public.idx_registration_guests_table_number;
DROP INDEX IF EXISTS public.idx_registration_guests_bidder_number;
DROP INDEX IF EXISTS public.idx_registration_guest_meal;
DROP INDEX IF EXISTS public.idx_npos_search_vector;
DROP INDEX IF EXISTS public.idx_npo_members_user_id;
DROP INDEX IF EXISTS public.idx_npo_members_npo_id;
DROP INDEX IF EXISTS public.idx_events_search_vector;
DROP INDEX IF EXISTS public.idx_events_npo_id_datetime;
DROP INDEX IF EXISTS public.idx_events_npo_id;
DROP INDEX IF EXISTS public.idx_events_event_datetime;
DROP INDEX IF EXISTS public.idx_auction_items_status;
DROP INDEX IF EXISTS public.idx_auction_items_sponsor_id;
DROP INDEX IF EXISTS public.idx_auction_items_event_status_type;
DROP INDEX IF EXISTS public.idx_auction_items_event_id;
DROP INDEX IF EXISTS public.idx_auction_items_bid_number;
DROP INDEX IF EXISTS public.idx_auction_items_auction_type;
DROP INDEX IF EXISTS public.idx_auction_item_media_item_id;
DROP INDEX IF EXISTS public.idx_auction_item_media_display_order;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.user_consents DROP CONSTRAINT IF EXISTS user_consents_pkey;
ALTER TABLE IF EXISTS ONLY public.event_registrations DROP CONSTRAINT IF EXISTS uq_user_event_registration;
ALTER TABLE IF EXISTS ONLY public.sponsors DROP CONSTRAINT IF EXISTS uq_sponsor_name_per_event;
ALTER TABLE IF EXISTS ONLY public.meal_selections DROP CONSTRAINT IF EXISTS uq_registration_guest_meal;
ALTER TABLE IF EXISTS ONLY public.npo_members DROP CONSTRAINT IF EXISTS uq_npo_member;
ALTER TABLE IF EXISTS ONLY public.auction_items DROP CONSTRAINT IF EXISTS uq_auction_items_event_bid_number;
ALTER TABLE IF EXISTS ONLY public.sponsors DROP CONSTRAINT IF EXISTS sponsors_pkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS roles_pkey;
ALTER TABLE IF EXISTS ONLY public.registration_guests DROP CONSTRAINT IF EXISTS registration_guests_pkey;
ALTER TABLE IF EXISTS ONLY public.npos DROP CONSTRAINT IF EXISTS npos_pkey;
ALTER TABLE IF EXISTS ONLY public.npo_members DROP CONSTRAINT IF EXISTS npo_members_pkey;
ALTER TABLE IF EXISTS ONLY public.npo_branding DROP CONSTRAINT IF EXISTS npo_branding_pkey;
ALTER TABLE IF EXISTS ONLY public.npo_applications DROP CONSTRAINT IF EXISTS npo_applications_pkey;
ALTER TABLE IF EXISTS ONLY public.meal_selections DROP CONSTRAINT IF EXISTS meal_selections_pkey;
...
ALTER TABLE IF EXISTS ONLY public.food_options DROP CONSTRAINT IF EXISTS food_options_pkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_pkey;
ALTER TABLE IF EXISTS ONLY public.event_registrations DROP CONSTRAINT IF EXISTS event_registrations_pkey;
ALTER TABLE IF EXISTS ONLY public.event_media DROP CONSTRAINT IF EXISTS event_media_pkey;
ALTER TABLE IF EXISTS ONLY public.event_links DROP CONSTRAINT IF EXISTS event_links_pkey;
ALTER TABLE IF EXISTS ONLY public.cookie_consents DROP CONSTRAINT IF EXISTS cookie_consents_pkey;
ALTER TABLE IF EXISTS ONLY public.consent_audit_logs DROP CONSTRAINT IF EXISTS consent_audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.auction_items DROP CONSTRAINT IF EXISTS auction_items_pkey;
ALTER TABLE IF EXISTS ONLY public.auction_item_media DROP CONSTRAINT IF EXISTS auction_item_media_pkey;
...
DROP TABLE IF EXISTS public.registration_guests;
DROP TABLE IF EXISTS public.npos;
DROP TABLE IF EXISTS public.npo_members;
DROP TABLE IF EXISTS public.npo_branding;
DROP TABLE IF EXISTS public.npo_applications;
DROP TABLE IF EXISTS public.meal_selections;
DROP TABLE IF EXISTS public.legal_documents;
DROP TABLE IF EXISTS public.invitations;
DROP TABLE IF EXISTS public.food_options;
...
DROP SEQUENCE IF EXISTS public.event_a2342a83_0141_4512_88b5_6e460bb11dfd_bid_number_seq;
DROP SEQUENCE IF EXISTS public.event_1145ecbb_9493_4e07_b6fe_d725915d55ea_bid_number_seq;
DROP SEQUENCE IF EXISTS public.event_10adb96b_75b8_4a43_8a44_c593cb853e3c_bid_number_seq;
DROP TABLE IF EXISTS public.cookie_consents;
DROP TABLE IF EXISTS public.consent_audit_logs;
DROP TABLE IF EXISTS public.audit_logs;
DROP TABLE IF EXISTS public.auction_items;
DROP TABLE IF EXISTS public.auction_item_media;
DROP TABLE IF EXISTS public.alembic_version;
DROP FUNCTION IF EXISTS public.prevent_audit_modification();
DROP FUNCTION IF EXISTS public.check_bidder_number_uniqueness();
DROP TYPE IF EXISTS public.submissionstatus;
DROP TYPE IF EXISTS public.registration_status;
DROP TYPE IF EXISTS public.npo_status;
...
DROP TYPE IF EXISTS public.legal_document_status;
DROP TYPE IF EXISTS public.invitation_status;
DROP TYPE IF EXISTS public.event_status;
DROP TYPE IF EXISTS public.event_media_type;
DROP TYPE IF EXISTS public.event_media_status;
DROP TYPE IF EXISTS public.event_link_type;
DROP TYPE IF EXISTS public.consent_status;
DROP TYPE IF EXISTS public.consent_action;
DROP TYPE IF EXISTS public.application_status;
--
-- Name: application_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.application_status OWNER TO augeo_user;

--
-- Name: consent_action; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.consent_action OWNER TO augeo_user;

--
-- Name: consent_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.consent_status OWNER TO augeo_user;

--
-- Name: event_link_type; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.event_link_type OWNER TO augeo_user;

--
-- Name: event_media_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.event_media_status OWNER TO augeo_user;

--
-- Name: event_media_type; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.event_media_type OWNER TO augeo_user;

--
-- Name: event_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.event_status OWNER TO augeo_user;

--
-- Name: invitation_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.invitation_status OWNER TO augeo_user;

--
-- Name: legal_document_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.legal_document_status OWNER TO augeo_user;

--
-- Name: legal_document_type; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.legal_document_type OWNER TO augeo_user;

--
-- Name: member_role; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.member_role OWNER TO augeo_user;

--
-- Name: member_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.member_status OWNER TO augeo_user;

--
-- Name: npo_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.npo_status OWNER TO augeo_user;

--
-- Name: registration_status; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.registration_status OWNER TO augeo_user;

--
-- Name: submissionstatus; Type: TYPE; Schema: public; Owner: augeo_user
--
...
ALTER TYPE public.submissionstatus OWNER TO augeo_user;

--
-- Name: check_bidder_number_uniqueness(); Type: FUNCTION; Schema: public; Owner: augeo_user
--
...
ALTER FUNCTION public.check_bidder_number_uniqueness() OWNER TO augeo_user;

--
-- Name: prevent_audit_modification(); Type: FUNCTION; Schema: public; Owner: augeo_user
--
...
ALTER FUNCTION public.prevent_audit_modification() OWNER TO augeo_user;
...
--
-- Name: alembic_version; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.alembic_version OWNER TO augeo_user;

--
-- Name: auction_item_media; Type: TABLE; Schema: public; Owner: augeo_user
--
...
CREATE TABLE public.auction_item_media (
    ...
    CONSTRAINT ck_auction_item_media_type CHECK (((media_type)::text = ANY ((ARRAY['image'::character varying, 'video'::character varying])::text[])))
);


ALTER TABLE public.auction_item_media OWNER TO augeo_user;

--
-- Name: auction_items; Type: TABLE; Schema: public; Owner: augeo_user
--
...
CREATE TABLE public.auction_items (
    ...
    CONSTRAINT ck_auction_items_auction_type CHECK (((auction_type)::text = ANY ((ARRAY['live'::character varying, 'silent'::character varying])::text[]))),
    ...
    CONSTRAINT ck_auction_items_status CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'published'::character varying, 'sold'::character varying, 'withdrawn'::character varying])::text[])))
);


ALTER TABLE public.auction_items OWNER TO augeo_user;

--
-- Name: audit_logs; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.audit_logs OWNER TO augeo_user;

--
-- Name: consent_audit_logs; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.consent_audit_logs OWNER TO augeo_user;

--
-- Name: cookie_consents; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.cookie_consents OWNER TO augeo_user;

--
-- Name: event_10adb96b_75b8_4a43_8a44_c593cb853e3c_bid_number_seq; Type: SEQUENCE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.event_10adb96b_75b8_4a43_8a44_c593cb853e3c_bid_number_seq OWNER TO augeo_user;

--
-- Name: event_1145ecbb_9493_4e07_b6fe_d725915d55ea_bid_number_seq; Type: SEQUENCE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.event_1145ecbb_9493_4e07_b6fe_d725915d55ea_bid_number_seq OWNER TO augeo_user;

--
-- Name: event_a2342a83_0141_4512_88b5_6e460bb11dfd_bid_number_seq; Type: SEQUENCE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.event_a2342a83_0141_4512_88b5_6e460bb11dfd_bid_number_seq OWNER TO augeo_user;

--
-- Name: event_links; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.event_links OWNER TO augeo_user;

--
-- Name: COLUMN event_links.label; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_links.platform; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_media; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.event_media OWNER TO augeo_user;

--
-- Name: COLUMN event_media.file_url; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.file_name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.file_type; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.file_size; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.display_order; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.media_type; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.mime_type; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_media.blob_name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_registrations; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.event_registrations OWNER TO augeo_user;

--
-- Name: TABLE event_registrations; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_registrations.status; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_registrations.ticket_type; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_registrations.number_of_guests; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN event_registrations.check_in_time; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: events; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.events OWNER TO augeo_user;

--
-- Name: COLUMN events.timezone; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.description; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.logo_url; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.primary_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.secondary_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.version; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.tagline; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.venue_city; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.venue_state; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.venue_zip; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.background_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.accent_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.attire; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.primary_contact_name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.primary_contact_email; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.primary_contact_phone; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN events.seating_layout_image_url; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: food_options; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.food_options OWNER TO augeo_user;

--
-- Name: COLUMN food_options.name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN food_options.description; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: invitations; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.invitations OWNER TO augeo_user;

--
-- Name: COLUMN invitations.invited_user_id; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.email; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.role; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.token_hash; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.expires_at; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.accepted_at; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.first_name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN invitations.last_name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: legal_documents; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.legal_documents OWNER TO augeo_user;

--
-- Name: meal_selections; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.meal_selections OWNER TO augeo_user;

--
-- Name: TABLE meal_selections; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN meal_selections.guest_id; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_applications; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.npo_applications OWNER TO augeo_user;

--
-- Name: COLUMN npo_applications.review_notes; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_branding; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.npo_branding OWNER TO augeo_user;

--
-- Name: COLUMN npo_branding.primary_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN npo_branding.secondary_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN npo_branding.logo_url; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN npo_branding.social_media_links; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN npo_branding.custom_css_properties; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN npo_branding.background_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN npo_branding.accent_color; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_members; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.npo_members OWNER TO augeo_user;

--
-- Name: COLUMN npo_members.joined_at; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npos; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.npos OWNER TO augeo_user;

--
-- Name: registration_guests; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.registration_guests OWNER TO augeo_user;

--
-- Name: TABLE registration_guests; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.user_id; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.name; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.email; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.phone; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.invited_by_admin; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.invitation_sent_at; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: COLUMN registration_guests.checked_in; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: roles; Type: TABLE; Schema: public; Owner: augeo_user
--
...
CREATE TABLE public.roles (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT role_name_valid CHECK (((name)::text = ANY ((ARRAY['super_admin'::character varying, 'npo_admin'::character varying, 'event_coordinator'::character varying, 'staff'::character varying, 'donor'::character varying])::text[]))),
    CONSTRAINT role_scope_valid CHECK (((scope)::text = ANY ((ARRAY['platform'::character varying, 'npo'::character varying, 'event'::character varying, 'own'::character varying])::text[])))
);


ALTER TABLE public.roles OWNER TO augeo_user;

--
-- Name: COLUMN roles.scope; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sessions; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.sessions OWNER TO augeo_user;

--
-- Name: sponsors; Type: TABLE; Schema: public; Owner: augeo_user
--
...
CREATE TABLE public.sponsors (
    ...
    CONSTRAINT ck_logo_size_enum CHECK (((logo_size)::text = ANY ((ARRAY['xsmall'::character varying, 'small'::character varying, 'medium'::character varying, 'large'::character varying, 'xlarge'::character varying])::text[])))
);


ALTER TABLE public.sponsors OWNER TO augeo_user;

--
-- Name: user_consents; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.user_consents OWNER TO augeo_user;

--
-- Name: users; Type: TABLE; Schema: public; Owner: augeo_user
--
...
ALTER TABLE public.users OWNER TO augeo_user;

--
-- Name: COLUMN users.social_media_links; Type: COMMENT; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: alembic_version; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: auction_item_media; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: auction_items; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: audit_logs; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: consent_audit_logs; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: cookie_consents; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: event_links; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: event_media; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: event_registrations; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: events; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: food_options; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: invitations; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: legal_documents; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: meal_selections; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: npo_applications; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: npo_branding; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: npo_members; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: npos; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: registration_guests; Type: TABLE DATA; Schema: public; Owner: augeo_user
--

COPY public.registration_guests (id, registration_id, user_id, name, email, phone, invited_by_admin, invitation_sent_at, created_at, updated_at, checked_in, bidder_number, table_number, bidder_number_assigned_at) FROM stdin;
21e6b3f9-8f4b-46bf-90e8-c9ca2b90d13f	fbf4847c-f57d-4604-a3f0-01d0e12e5f08	\N	Sarah Thompson	sarah.thompson@example.com	+1(555)123-4567	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:32:35.635943+00	f	\N	1	\N
29b46010-3d79-49e6-8e98-3b724e533275	fbf4847c-f57d-4604-a3f0-01d0e12e5f08	\N	Michael Chen	michael.chen@example.com	+1(555)234-5678	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:32:38.279433+00	f	\N	3	\N
d5c120d5-899c-4c06-bfcd-606c032688bd	fbf4847c-f57d-4604-a3f0-01d0e12e5f08	\N	Emily Rodriguez	emily.rodriguez@example.com	+1(555)345-6789	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:32:43.972424+00	f	\N	2	\N
45efd895-7432-447e-a8fe-820577870933	fbf4847c-f57d-4604-a3f0-01d0e12e5f08	\N	David Kim	david.kim@example.com	+1(555)456-7890	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:32:55.139281+00	f	\N	2	\N
8160e1a8-a5ff-4cc9-9596-2c4277755654	30528988-31a5-4e90-89b9-1400ebbf59d3	\N	Jessica Martinez	jessica.martinez@example.com	+1(555)567-8901	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:33:52.548676+00	f	\N	4	\N
1fb4d41d-a937-4d90-b16a-3ed23c39f88a	367db784-5561-4f59-8ea5-c6e56253bc60	\N	Justin Jeanes	jeanesjustin@gmail.com	8645536738	t	2025-11-23 21:55:41.861706+00	2025-11-23 21:55:41.798478+00	2025-12-16 13:48:47.651045+00	f	\N	2	\N
303debac-136b-4ea7-a113-b00f323d0f9f	c1d03ca2-bc0c-458e-a0eb-56bb59d76828	\N	Sophia Anderson	sophia.anderson@example.com	+1(555)123-5678	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
44118578-5da8-4037-835a-c3a21636df35	c1d03ca2-bc0c-458e-a0eb-56bb59d76828	\N	Olivia Davis	olivia.davis@example.com	+1(555)901-2345	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
71dac99c-7a8c-4548-bf2f-6d3b97a0ce46	30528988-31a5-4e90-89b9-1400ebbf59d3	\N	Daniel Brown	daniel.brown@example.com	+1(555)890-1234	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
8181487c-ae89-48b8-abc5-540bf91c4083	c1d03ca2-bc0c-458e-a0eb-56bb59d76828	\N	Matthew Taylor	matthew.taylor@example.com	+1(555)234-6789	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
da95d5ee-4b8b-48cd-874a-d3fcc6211ae2	30528988-31a5-4e90-89b9-1400ebbf59d3	\N	Christopher Lee	christopher.lee@example.com	+1(555)678-9012	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
e5dfcd84-646b-4823-8a93-e2bbd8d4ec89	367db784-5561-4f59-8ea5-c6e56253bc60	\N	John Rockefeller	John.Rockefeller@augeo.app	\N	t	2025-11-23 21:53:30.900573+00	2025-11-23 21:53:30.836306+00	2025-12-16 13:48:47.651045+00	f	\N	2	\N
f98d42ce-43f8-448c-9e12-bd9a0d9acefd	c1d03ca2-bc0c-458e-a0eb-56bb59d76828	\N	Ryan Wilson	ryan.wilson@example.com	+1(555)012-3456	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
fdff4b17-a4d7-48e4-b8cb-22ab58f82b9e	30528988-31a5-4e90-89b9-1400ebbf59d3	\N	Amanda Johnson	amanda.johnson@example.com	+1(555)789-0123	f	\N	2025-11-23 20:55:39.50922+00	2025-12-16 13:48:47.651045+00	f	\N	1	\N
\.


--
-- Data for Name: roles; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: sessions; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: sponsors; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: user_consents; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: augeo_user
--
...
1de4003e-2860-4d3e-bd9e-42fd18831b50	staff@test.com	$2b$12$XTNQJag6hr2xb8n.0NijcuGVkr4IUBoPxP7Ms02UEHMEm2I.t.juW	Staff	Member	+1234567890	t	t	c2921020-3b7b-4e7a-9f29-2f7e6cfd2faf	\N	2025-10-24 15:16:16.808947+00	2025-10-24 15:16:16.808947+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
...
25d5958f-9480-4da8-914a-f1f220d67b9b	josh@augeo.app	$2b$12$wJzgu0ecmQ7HejjuWBo7feKXTD.1JoIVYFiVvGkbVB.eDr0YPSbJu	Josh	Jeanes	+1234567890	t	t	a928717b-0764-44eb-ac09-04daf4f880f8	\N	2025-10-31 18:03:29.339142+00	2025-10-31 18:04:41.741184+00	2025-10-31 22:04:41.744151+00	\N	\N	\N	\N	\N	\N	\N	\N	\N
...
061cd97f-9ad6-48a8-9dc4-80a8353ea255	staff.brightpath@augeo.app	$2b$12$/XrCKfzmxvFoUBaxPhF5aeWi1o6XI7leqclYyEtlPOC88unQs1O4y	Staff	BrightPath	\N	t	t	a928717b-0764-44eb-ac09-04daf4f880f8	\N	2025-11-05 14:11:38.87934+00	2025-11-05 14:19:20.492097+00	2025-11-05 19:19:20.495737+00	\N	\N	\N	\N	\N	\N	\N	\N	\N
8035482b-c4bf-4b80-991b-7a03580771e4	co-admin.brightpath@augeo.app	$2b$12$D8bCzrlxIQZ.2U8lzGNDEu2U3lRJLMgO5cu07hTRDNysGa5At0lg6	Co-Admin	Brightpath		t	t	a928717b-0764-44eb-ac09-04daf4f880f8	\N	2025-11-05 14:34:40.868274+00	2025-11-06 01:45:18.679433+00	2025-11-06 06:45:18.682666+00	\N	\N	\N	\N	\N	\N	\N	\N	\N
...
a65cf82f-8b98-4dc3-be15-f42352d6e2c0	superadmin@augeo.app	$2b$12$0fb0a5KcM3MSA3tXDnh64.sevnw01baNcvh8CB/CQS.lOmz9b5Yaq	Super	Admin	\N	t	t	97df5649-b5ec-43c5-bd90-093010cbc428	\N	2025-11-06 14:16:09.788978+00	2025-11-06 14:43:23.824812+00	2025-11-06 19:43:23.827907+00	\N	\N	\N	\N	\N	\N	\N	\N	\N
b25889fa-76a3-4008-950c-6d7ee0cb5f01	super_admin@test.com	$2b$12$HqpeoEd/gXqNQaRrsoqHOuO.br803IUj./yO1pHALnj3pva1M2TUe	Super	Admin	+1234567890	t	t	97df5649-b5ec-43c5-bd90-093010cbc428	\N	2025-10-24 15:16:16.808947+00	2025-12-17 02:22:29.980488+00	2025-12-17 07:22:29.98483+00	\N	\N	\N	\N	\N	\N	\N	https://augeodevst.blob.core.windows.net/npo-assets/logos/b25889fa-76a3-4008-950c-6d7ee0cb5f01/20251119_215307_8d22da8e_AugeoLogo-whiteonblack.jpg?se=2026-11-19T21%3A53%3A07Z&sp=r&sv=2025-11-05&sr=b&sig=s1VgpYJkrSFoRRb8Uk3Wfpqstn8e%2B7admX0zTkWd8eg%3D	\N
f5685f29-eb11-44ac-be25-fc2e691883ef	admin@augeo.app	$2b$12$qHMsARsehY45ifdBSakJHOqjy8xJ6wk0Bme8YahYs0dNMgP1KXmoK	Super	Admin	\N	t	t	97df5649-b5ec-43c5-bd90-093010cbc428	\N	2025-10-25 01:16:48.262787+00	2025-11-24 18:26:17.758733+00	2025-11-24 23:26:17.762217+00	\N	\N	\N	\N	\N	\N	\N	\N	\N
...
--
-- Name: event_10adb96b_75b8_4a43_8a44_c593cb853e3c_bid_number_seq; Type: SEQUENCE SET; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_1145ecbb_9493_4e07_b6fe_d725915d55ea_bid_number_seq; Type: SEQUENCE SET; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_a2342a83_0141_4512_88b5_6e460bb11dfd_bid_number_seq; Type: SEQUENCE SET; Schema: public; Owner: augeo_user
--
...
--
-- Name: alembic_version alembic_version_pkc; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_item_media auction_item_media_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_items auction_items_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: audit_logs audit_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: consent_audit_logs consent_audit_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: cookie_consents cookie_consents_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_links event_links_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_media event_media_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_registrations event_registrations_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: events events_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: food_options food_options_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: invitations invitations_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: legal_documents legal_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: meal_selections meal_selections_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_applications npo_applications_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_branding npo_branding_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_members npo_members_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npos npos_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: registration_guests registration_guests_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: roles roles_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sponsors sponsors_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_items uq_auction_items_event_bid_number; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_members uq_npo_member; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: meal_selections uq_registration_guest_meal; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sponsors uq_sponsor_name_per_event; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_registrations uq_user_event_registration; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: user_consents user_consents_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_item_media_display_order; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_item_media_item_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_items_auction_type; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_items_bid_number; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_items_event_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_items_event_status_type; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_items_sponsor_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_auction_items_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_events_event_datetime; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_events_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_events_npo_id_datetime; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_events_search_vector; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_npo_members_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_npo_members_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_npos_search_vector; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_registration_guest_meal; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_registration_guests_bidder_number; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_registration_guests_table_number; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_sponsors_created_by; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_sponsors_display_order; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_sponsors_event_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_user_event_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: idx_users_search_vector; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_audit_logs_action; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_audit_logs_created_at; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_audit_logs_ip_address; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_audit_logs_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_consent_audit_logs_action; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_consent_audit_logs_created_at; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_consent_audit_logs_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_cookie_consents_session_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_cookie_consents_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_event_links_event_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_event_media_event_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_event_registrations_event_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_event_registrations_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_event_registrations_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_events_event_datetime; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_events_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_events_slug; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_events_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_food_options_event_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_invitations_email; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_invitations_expires_at; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_invitations_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_invitations_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_invitations_token_hash; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_legal_documents_document_type; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_legal_documents_published_at; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_legal_documents_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_meal_selections_food_option_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_meal_selections_guest_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_meal_selections_registration_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_applications_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_applications_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_applications_submitted_at; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_branding_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_members_npo_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_members_role; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_members_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npo_members_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npos_created_by_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npos_email; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npos_name; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_npos_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_registration_guests_email; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_registration_guests_registration_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_registration_guests_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_roles_name; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_sessions_created_at; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_sessions_refresh_token_jti; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_sessions_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_user_consents_status; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_user_consents_user_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_users_email; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: ix_users_role_id; Type: INDEX; Schema: public; Owner: augeo_user
--
...
--
-- Name: consent_audit_logs prevent_consent_audit_update; Type: TRIGGER; Schema: public; Owner: augeo_user
--
...
--
-- Name: registration_guests trg_check_bidder_number_uniqueness; Type: TRIGGER; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_item_media auction_item_media_auction_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_items auction_items_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_items auction_items_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: auction_items auction_items_sponsor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: audit_logs audit_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: consent_audit_logs consent_audit_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: cookie_consents cookie_consents_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_links event_links_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_links event_links_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_media event_media_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_media event_media_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_registrations event_registrations_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: event_registrations event_registrations_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: events events_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: events events_npo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: events events_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: food_options food_options_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: invitations invitations_invited_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: invitations invitations_invited_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: invitations invitations_npo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: meal_selections meal_selections_food_option_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: meal_selections meal_selections_guest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: meal_selections meal_selections_registration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_applications npo_applications_npo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_applications npo_applications_reviewed_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_branding npo_branding_npo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_members npo_members_invited_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_members npo_members_npo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npo_members npo_members_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: npos npos_created_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: registration_guests registration_guests_registration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: registration_guests registration_guests_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sessions sessions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sponsors sponsors_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: sponsors sponsors_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: user_consents user_consents_privacy_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: user_consents user_consents_tos_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: user_consents user_consents_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
--
-- Name: users users_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: augeo_user
--
...
\unrestrict MpDITcy4TFX4jLJCcgNVZfp6dhsucCggxj4dBMFkp5ld0G03Z1Rfg3WdGkX1YVI
