...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", checkout_status_enum, nullable=False, server_default="not_started"),
        sa.Column("payment_method", checkout_payment_method_enum, nullable=True),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type",
            checkout_item_source_type_enum,
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column("action", checkout_audit_action_enum, nullable=False),
        sa.Column(
            "item_id",
            postgresql.UUID(as_uuid=True),
