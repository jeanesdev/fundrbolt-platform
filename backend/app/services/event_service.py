...
class EventService:
    ...
    async def duplicate_event(
        ...
        new_event = Event(
            ...
            page_background_style=source_event.page_background_style,
            page_background_image_url=source_event.page_background_image_url,
            page_background_gradient_start_color=source_event.page_background_gradient_start_color,
            page_background_gradient_end_color=source_event.page_background_gradient_end_color,
            ...
            action_card_gradient_start_color=source_event.action_card_gradient_start_color,
            action_card_gradient_end_color=source_event.action_card_gradient_end_color,
            action_card_background_opacity=source_event.action_card_background_opacity,
            cause_section_border_color=source_event.cause_section_border_color,
            cause_section_border_width=source_event.cause_section_border_width,
