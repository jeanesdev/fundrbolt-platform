  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Hear from nonprofits, attendees, and auctioneers who have transformed their fundraising with FundrBolt's mobile silent auction platform."
        />
      ...
      <section className="testimonials-hero">
        <div className="container">
          ...
          <p className="hero-subtitle">
            Hear from nonprofits, attendees, and auctioneers who are transforming
      ...
      <section className="testimonials-cta">
        <div className="container">
          ...
          <p>
            Join hundreds of nonprofits, attendees, and auctioneers using FundrBolt to
