        ...
        <section className='bg-muted/50 rounded-lg border p-6'>
          ...
          <div className='text-muted-foreground space-y-2 text-sm'>
            <p>
              ...
              personal data. This page provides tools to exercise those rights.
            </p>
            <p>
              <strong>Data Export:</strong> Request a complete copy of your data
              in machine-readable format.
            </p>
            <p>
              <strong>Withdraw Consent:</strong> Revoke your consent to data
              processing (deactivates account).
            </p>
            <p>
              <strong>Account Deletion:</strong> Request permanent deletion of
              your account and data (30-day grace period).
            </p>
            <p className='mt-4'>
