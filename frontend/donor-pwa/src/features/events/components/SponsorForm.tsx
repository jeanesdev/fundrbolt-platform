...
export function SponsorForm({
  ...
  const [logoPreview, setLogoPreview] = useState<string | null>(
    sponsor?.thumbnail_url || sponsor?.logo_url || null
  )
  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6'>
      ...
      <div className='space-y-2'>
        <Label htmlFor='logo'>
          Sponsor Logo {!isEdit && <span className='text-destructive'>*</span>}
        </Label>
        <div className='flex gap-4'>
          {logoPreview && (
            <div className='bg-muted relative flex h-32 w-32 items-center justify-center overflow-hidden rounded-md'>
              <img
                src={logoPreview}
                alt='Logo preview'
      ...
      <div className='grid gap-4 sm:grid-cols-2'>
        ...
        <div className='space-y-2'>
          <Label htmlFor='logo_size'>
            Logo Size <span className='text-destructive'>*</span>
          </Label>
          <Select
            value={formData.logo_size}
            onValueChange={(value) =>
              setFormData({ ...formData, logo_size: value as LogoSize })
            }
            disabled={isSubmitting}
          >
        ...
        <div className='space-y-2'>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, sponsor_level: e.target.value })
            }
            disabled={isSubmitting}
