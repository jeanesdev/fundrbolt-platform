...
export function CookiePreferences() {
  const { preferences, hasConsent, updateConsent, isLoading, fetchConsent } =
    useCookieStore()
  ...
  return (
    <div className='space-y-6'>
        ...
        <Card className='border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950'>
          <CardContent className='pt-6'>
            <div className='flex items-start gap-3'>
              <Cookie className='mt-0.5 h-5 w-5 text-amber-600 dark:text-amber-400' />
              <div>
                <h3 className='font-semibold text-amber-900 dark:text-amber-100'>
                  No preferences set
                </h3>
                <p className='mt-1 text-sm text-amber-700 dark:text-amber-300'>
                  You haven't set your cookie preferences yet. By default, only
      ...
      <Card>
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='flex-1'>
              ...
              <CardDescription className='mt-2'>
                ...
                cannot be disabled. They are usually only set in response to
        ...
        <CardContent>
          <div className='text-muted-foreground space-y-2 text-sm'>
            ...
            <p>
              <strong>Storage:</strong> These cookies are stored locally in your
              browser and are deleted when you close your session or logout.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className={analytics ? 'border-primary/50' : ''}>
        <CardHeader>
          <div className='flex items-start gap-3'>
            <BarChart3 className='mt-1 h-5 w-5 text-blue-600' />
            <div className='flex-1'>
              ...
              <CardDescription className='mt-2'>
                ...
                us know which pages are the most and least popular and see how
        ...
        <CardContent>
          <div className='text-muted-foreground space-y-2 text-sm'>
            ...
            <p>
              ...
              platform to improve user experience and identify issues.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className={marketing ? 'border-primary/50' : ''}>
        <CardHeader>
          <div className='flex items-start gap-3'>
            <Megaphone className='mt-1 h-5 w-5 text-purple-600' />
            <div className='flex-1'>
              ...
              <CardDescription className='mt-2'>
                ...
                and show you relevant ads on other sites. They work by uniquely
        ...
        <CardContent>
          <div className='text-muted-foreground space-y-2 text-sm'>
            <p>
              <strong>Examples:</strong> Advertising networks, remarketing tags,
              conversion tracking
            </p>
            <p>
              <strong>Purpose:</strong> Show you relevant advertisements and
