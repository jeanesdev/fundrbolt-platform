...
function DetailRow({
  ...
  const content = href ? (
    ...
    <span style={{ color: 'var(--event-text-on-background, #000000)' }}>
      {value}
    </span>
  )
  ...
  return (
    <div className='flex items-start gap-3'>
      ...
      <div>
        <p
          className='mb-0.5 text-xs tracking-wide uppercase'
    ...
    >
      ...
      <Collapsible.Content className='data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp overflow-hidden'>
        <div className='grid gap-4 px-4 pb-4 sm:grid-cols-2'>
          ...
          {/* Attire */}
          {attire && <DetailRow icon={Shirt} label='Attire' value={attire} />}
