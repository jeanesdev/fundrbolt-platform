      ...
      {!isPrimaryImageLoaded && (
        ...
        >
          <ImageIcon
            ...
            style={{ color: 'var(--event-card-text, #000)' }}
          />
        </div>
      )}
      <img
      ...
      >
        ...
        {onToggleWatch && (
          <button
            ...
            className='absolute top-2 left-2 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-black/50 text-white backdrop-blur-sm transition-all hover:bg-black/70 active:scale-90'
            aria-label={isWatched ? 'Stop watching' : 'Watch this item'}
          >
            <Heart
              className={cn(
                'h-3.5 w-3.5 transition-all',
                isWatched && 'fill-current text-red-400'
              )}
            />
          </button>
        )}
        ...
        {isHot && !isCurrentUserWinning && (
          <div className='absolute right-2 bottom-2 z-10 flex items-center gap-1 rounded-full bg-orange-500/90 px-2 py-0.5 text-[10px] font-bold text-white'>
        ...
        {item.promotion_badge && (
          <div className='absolute top-10 left-2 z-10 rounded-full bg-amber-500/90 px-2 py-0.5 text-[10px] font-bold text-white shadow'>
            {item.promotion_badge}
          </div>
        )}
        ...
        {!isHot &&
          ...
          item.watcher_count > 0 && (
            <div className='absolute right-2 bottom-2 z-10 flex items-center gap-1 rounded-full bg-black/50 px-2 py-0.5 text-[10px] text-white backdrop-blur-sm'>
