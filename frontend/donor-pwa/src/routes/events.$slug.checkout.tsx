...
function EventCheckoutPage() {
  ...
  const checkoutConfettiFiredRef = useRef(false)
  ...
  useEffect(() => {
    if (session?.status !== 'complete') {
      checkoutConfettiFiredRef.current = false
      return
    }

    if (!checkoutConfettiFiredRef.current) {
      checkoutConfettiFiredRef.current = true
