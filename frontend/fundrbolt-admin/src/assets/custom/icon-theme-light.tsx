  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={colors.palette.cloud}
      />
      <circle cx={6.7} cy={7.04} r={3.54} fill={colors.secondary.white} />
      <path
      ...
      <circle cx={62.74} cy={16.32} r={8} fill={colors.secondary.white} />
      <g fill={colors.palette.silver}>
