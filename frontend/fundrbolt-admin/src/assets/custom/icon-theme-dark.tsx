...
export function IconThemeDark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g fill={colors.palette.midnightSlate}>
      ...
      <path
        ...
        fill={colors.palette.obsidian}
      />
      <circle cx={6.7} cy={7.04} r={3.54} fill={colors.palette.steelBlue} />
      <path
        ...
        fill={colors.palette.steelBlue}
      />
      <g fill={colors.palette.cobalt}>
        <rect
          x={33.36}
          y={19.73}
          width={2.75}
